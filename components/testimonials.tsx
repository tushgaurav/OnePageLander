            ...
            <div className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up">
              <div>
                <div className="relative inline-flex flex-col mb-4">
                  ...
                  <svg className="absolute top-0 right-0 -mr-3 w-6 h-5 fill-current text-amber-300" viewBox="0 0 24 20" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <cite className="text-gray-200 not-italic">Anastasia Dan</cite> - <a className="text-amber-300 hover:text-gray-200 transition duration-150 ease-in-out" href="#0">UX Board</a>
              </div>
            </div>
